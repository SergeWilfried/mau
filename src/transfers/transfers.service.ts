...
export class TransfersService {
    ...
    async internalTransfer(userId: string, fromAccountId: string, toAccountId: string, amount: number) {
    ...
    async cryptoTransfer(
        ...
        await this.supabaseService.getAdminClient().from('crypto_transactions').insert({
            user_id: userId,
