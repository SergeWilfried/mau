...
export class ExchangeService {
    ...
    private mockRates: Record<string, Record<string, number>> = {
        ...
        USD: { EUR: 0.93, GBP: 0.8, MAD: 10.05, CHF: 0.87, JPY: 150.5, CAD: 1.36 },
        GBP: { EUR: 1.16, USD: 1.25, MAD: 12.6, CHF: 1.09, JPY: 188.7, CAD: 1.7 }
    };
    ...
    async getQuote(body: { fromCurrency: string; toCurrency: string; fromAmount?: number; toAmount?: number }) {
    ...
    async convert(userId: string, fromAccountId: string, toAccountId: string, fromAmount?: number, toAmount?: number) {
