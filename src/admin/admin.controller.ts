...
export class AdminController {
    ...
    suspendUser(@CurrentUser() admin: any, @Param('userId') userId: string, @Body() body: { reason: string }) {
    ...
    @Get('kyc/pending')
    getPendingKyc(@Query('limit') limit?: number, @Query('offset') offset?: number) {
    ...
    rejectKyc(@CurrentUser() admin: any, @Param('documentId') documentId: string, @Body() body: { reason: string }) {
    ...
    getPendingTransfers(@Query('limit') limit?: number, @Query('offset') offset?: number) {
