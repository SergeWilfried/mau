...
export class TransactionsController {
    ...
    @Get('recent')
    getRecentTransactions(@CurrentUser() user: any, @Query('limit') limit: number = 10) {
    ...
    @Get('search/query')
    searchTransactions(@CurrentUser() user: any, @Query('q') query: string, @Query('limit') limit: number = 20) {
    ...
    getSpendingByCategory(@CurrentUser() user: any, @Query('from') from: string, @Query('to') to: string) {
    ...
    @Get(':transactionId')
    getTransaction(@CurrentUser() user: any, @Param('transactionId') transactionId: string) {
