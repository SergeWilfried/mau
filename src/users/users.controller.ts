...
export class UsersController {
    ...
    uploadKycDocument(@CurrentUser() user: any, @Body() body: { type: string; filePath: string }) {
    ...
    @Put('me/settings')
    updateSettings(@CurrentUser() user: any, @Body() body: { language?: string; currency?: string }) {
    ...
    registerDevice(
        @CurrentUser() user: any,
        @Body()
        body: { deviceName: string; deviceType: string; pushToken?: string; platform: 'ios' | 'android' | 'web' }
    ) {
