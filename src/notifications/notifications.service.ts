...
export class NotificationsService {
  ...
  async updatePreferences(userId: string, preferences: {
    ...
    if (preferences.email) {
      if (preferences.email.transactions !== undefined) updates.email_transactions = preferences.email.transactions;
      ...
      if (preferences.email.monthlyStatement !== undefined) updates.email_monthly_statement = preferences.email.monthlyStatement;
    }

    if (preferences.sms) {
      if (preferences.sms.security !== undefined) updates.sms_security = preferences.sms.security;
      if (preferences.sms.largeTransactions !== undefined) updates.sms_large_transactions = preferences.sms.largeTransactions;
    }
